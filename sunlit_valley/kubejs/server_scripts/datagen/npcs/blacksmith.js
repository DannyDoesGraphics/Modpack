  ...
  runNpcDatagen("blacksmith", {
    ...
    chatter: {
      friendship0: [
        ...
        ["I was taking a walk the other day and I swear I saw a peice of coal with legs...", "There's some strange magic in these caves I'm sure of it!"],
      ...
      friendship2: [
        ...
        ["Hmmm nobody seems to be buying pitchforks at Leons.", "Or maybe a certain someone forgot to put in an order again..."],
      ...
      friendship4: [
        ...
        "♫ Heya hiya @i! ♫",
        ["I always get a little self-conscious when Caroline's audting my stock.", "She can be harsh sometimes but it always seems to come from a good place."],
