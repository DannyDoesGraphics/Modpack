StartupEvents.registry('item', event => {
    ...
    event.create("dam:patterned_wafer").texture("dam:item/silicon_wafer").displayName("Patterned Wafer");
    event.create("dam:metallized_wafer").texture("dam:item/silicon_wafer").displayName("Metallized Wafer");
    event.create("dam:defective_wafer").texture("dam:item/silicon_wafer").displayName("Defective Wafer");
    event.create("dam:defective_metallized_wafer").texture("dam:item/silicon_wafer").displayName("Defective Metallized Wafer");
